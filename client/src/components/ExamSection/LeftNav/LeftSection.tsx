...
import Subject from '../rightPart/Subject';
               ...
               <div className="flex-1 px-3 pt-14 divide-y space-y-1">
                  <ul className="space-y-2 pb-2">
                     <li className=" rounded-xl">
                        <Link to="/user" className="text-base text-white font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                     ...
                     <li className="rounded-xl">
                        <Link to="" className="text-base text-white font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                           <svg className="w-6 h-6 text-white group-hover:text-white transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                              <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
                              <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path>
                           </svg>
                          
                           <span className="ml-3 font-mono">Add new users</span>
                        </Link>
                     </li>
                     ...
                     <li className="">
                        <Link to="" className="text-base text-white font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                           <svg className="w-6 h-6 text-white flex-shrink-0 group-hover:text-white transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path>
                           </svg>
                           <span className="ml-3 font-mono">Add New Courses</span>
                        </Link>
                     </li>
                     <li className="">
                        <Link to="" className="text-base text-white font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                     ...
                     <li className="">
                        <Link to="" className="text-base text-white font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                           ...
                           <span className="ml-3 flex-1 whitespace-nowrap font-mono">Add New Subjects</span>
                        </Link>
                     </li>
                     <li className="">
                        <Link to="" className="text-base text-white font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                           ...
                           <span className="ml-3 flex-1 whitespace-nowrap font-mono">Add new Question</span>
                        </Link>
                     </li>
                  </ul>
